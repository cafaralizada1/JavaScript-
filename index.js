let results = [
  ...
  // let x = results.filter((item) => item.order.customerId == "ERNSH");
// console.log(x.length);

// results.sort((a,b) => a.order.employeeId - b.order.employeeId);
// console.log(results);

// let z = results.filter((item) => item.orderDetails.length > "3")
// console.log(z);

// let y = results.find((item) => item.order.id === 11075)
// console.log(y);

// let d = results.filter(item => item.order.freight <1);
// console.log(d);